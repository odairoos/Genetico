...
# Cromossomo tem um tamanho (número m de genes)
    ...
    creator.create("EstruturaIndividuo", array.array, fitness=creator.FitnessMax, strategy=None) # all_coords
   ...
   # Gerador de parametros
    ...
    #pop = toolbox.Populacao(n=1000) # alterar esse número depois
